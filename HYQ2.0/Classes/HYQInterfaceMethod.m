...
// *获取二维码图*
NSString *const GET_QRURL_INTERFACE             =       @"http://192.168.1.93:90/r/";
//* 启动banner*
NSString *const LAUNCH_ADVERTISE_INTERFACE         =       @"http://192.168.1.93:90/app/appInterfaceProject!homePhotoIOS.action";
//--------------------
// * 首页 *
...
//产品服务详情页
NSString *const PRODUCT_DETAIL_INTERFACE        =       @"http://192.168.1.93:90/web/weixinpay2/product!view.action?id=";
//产品信息详情页
...
//我的积分
NSString *const MY_SIGN_IN_INTERFACE            =       @"http://192.168.1.93:90/app/appInterfaceUser!myPoints.action";
...
//-----------------------------
//优创计划
NSString *const EXCELLENT_PLAN_INTERFACE        =       @"http://192.168.1.93:90/m/plan/planlist/YCJH2?biaoshi=iOS";
//优创金融方案
NSString *const EXCELLENT_FINANTIAL_INTERFACE   =       @"http://192.168.1.93:90/m/plan/planlist/YCJRFA?biaoshi=iOS";
//优创基地
NSString *const EXCELLENT_BASE_INTERFACE        =       @"http://192.168.1.93:90/m/plan/planlist/YCJD?biaoshi=iOS";
//优创训练营
NSString *const EXCELLENT_CAMP_INTERFACE        =       @"http://192.168.1.93:90/m/plan/planlist/YCXLY?biaoshi=iOS";
//优创开放日
NSString *const EXCELLENT_OPEN_INTERFACE        =       @"http://192.168.1.93:90/m/plan/planlist/YCKFR?biaoshi=iOS";
