...
- (void)setViews
{
    if (!_desLbl) {
        ...
        NSString *str = @"选择服务类型搭配产品";
        NSMutableAttributedString *attriStr = [[NSMutableAttributedString alloc] initWithString:str];
        [attriStr setAttributes:@{NSForegroundColorAttributeName:NAVIBAR_GREEN_COLOR,NSFontAttributeName:[UIFont systemFontOfSize:13.0f]} range:NSMakeRange(2, 4)];
        ...
        [attriStr setAttributes:@{NSForegroundColorAttributeName:[UIColor blackColor],NSFontAttributeName:[UIFont systemFontOfSize:13.0f]} range:NSMakeRange(6, 4)];
